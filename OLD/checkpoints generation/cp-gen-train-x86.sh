...
(time $GEM5/build/X86/gem5.fast --outdir=../train $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/x86/453.povray/simpoint/simpoint_train,$BENCH_DATA/x86/453.povray/simpoint/weight_train,100000000,0 --output=../train/povray.out --cmd=$SPEC/453.povray/exe/povray_base.x86 --options="SPEC-benchmark-train.ini") &> ../train/gem5.453povray.log &
cd ../../..
...
(time $GEM5/build/X86/gem5.fast --outdir=../train $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/x86/456.hmmer/simpoint/simpoint_train,$BENCH_DATA/x86/456.hmmer/simpoint/weight_train,100000000,0 --output=../train/456hmmer.out --cmd=$SPEC/456.hmmer/exe/hmmer_base.x86 --options="--fixed 0 --mean 425 --num 85000 --sd 300 --seed 0 leng100.hmm") &> ../train/gem5.456hmmer.log &
cd ../../..
...
(time $GEM5/build/X86/gem5.fast --outdir=../train $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/x86/458.sjeng/simpoint/simpoint_train,$BENCH_DATA/x86/458.sjeng/simpoint/weight_train,100000000,0 --output=../train/458sjeng.out --cmd=$SPEC/458.sjeng/exe/sjeng_base.x86 --options="train.txt") &> ../train/gem5.458sjeng.log &
cd ../../..
...
(time $GEM5/build/X86/gem5.fast --outdir=../train $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/x86/462.libquantum/simpoint/simpoint_train,$BENCH_DATA/x86/462.libquantum/simpoint/weight_train,100000000,0 --output=../train/462libquantum.out --cmd=$SPEC/462.libquantum/exe/libquantum_base.x86 --options="143 25") &> ../train/gem5.462libquantum.log &
cd ../../..
...
#(time $GEM5/build/X86/gem5.fast --outdir=../train $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/x86/465.tonto/simpoint/simpoint_train,$BENCH_DATA/x86/465.tonto/simpoint/weight_train,100000000,0 --output=../train/465tonto.out --cmd=$SPEC/465.tonto/exe/tonto_base.x86 --options="< stdin") &> ../train/gem5.465tonto.log &
#cd ../../..
...
(time $GEM5/build/X86/gem5.fast --outdir=../train $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/x86/470.lbm/simpoint/simpoint_train,$BENCH_DATA/x86/470.lbm/simpoint/weight_train,100000000,0 --output=../train/470lbm.out --cmd=$SPEC/470.lbm/exe/lbm_base.x86 --options="300 reference.dat 0 1 100_100_130_cf_b.of") &> ../train/gem5.470lbm.log &
cd ../../..
...
(time $GEM5/build/X86/gem5.fast --outdir=../BigLakes1024_train $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/x86/473.astar/simpoint/simpoint_BigLakes1024_train,$BENCH_DATA/x86/473.astar/simpoint/weight_BigLakes1024_train,100000000,0 --output=../BigLakes1024_train/473astar.out --cmd=$SPEC/473.astar/exe/astar_base.x86 --options="BigLakes1024.cfg") &> ../BigLakes1024_train/gem5.473astar.log &
(time $GEM5/build/X86/gem5.fast --outdir=../rivers_train $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/x86/473.astar/simpoint/simpoint_rivers_train,$BENCH_DATA/x86/473.astar/simpoint/weight_rivers_train,100000000,0 --output=../rivers_train/473astar.out --cmd=$SPEC/473.astar/exe/astar_base.x86 --options="rivers1.cfg") &> ../rivers_train/gem5.473astar.log &
cd ../../..
...
ln -s le/64/* .
(time $GEM5/build/X86/gem5.fast --outdir=../train $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/x86/481.wrf/simpoint/simpoint_train,$BENCH_DATA/x86/481.wrf/simpoint/weight_train,100000000,0 --output=../train/481wrf.out --cmd=$SPEC/481.wrf/exe/wrf_base.x86) &> ../train/gem5.481wrf.log &
cd ../../..
...
(time $GEM5/build/X86/gem5.fast --outdir=../train $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/x86/482.sphinx3/simpoint/simpoint_train,$BENCH_DATA/x86/482.sphinx3/simpoint/weight_train,100000000,0 --output=../train/482sphinx3.out --cmd=$SPEC/482.sphinx3/exe/sphinx_livepretend_base.x86 --options="ctlfile . args.an4") &> ../train/gem5.482sphinx3.log &
cd ../../..
...
(time $GEM5/build/X86/gem5.fast --outdir=../train $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/x86/483.xalancbmk/simpoint/simpoint_train,$BENCH_DATA/x86/483.xalancbmk/simpoint/weight_train,100000000,0 --output=../train/483xalancbmk.out --cmd=$SPEC/483.xalancbmk/exe/Xalan_base.x86 --options="-v allbooks.xml xalanc.xsl") &> ../train/gem5.483xalancbmk.log &
cd ../../..
