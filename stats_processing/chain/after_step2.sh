...
# Plots
python plot_stuff.py step3/slowdown_int_sc-a53-odn2_stt-l2_typical.csv step3/slowdown_int_sc-a53-odn2_stt-l2_worst.csv
python plot_stuff.py step3/slowdown_fp_sc-a53-odn2_stt-l2_typical.csv step3/slowdown_fp_sc-a53-odn2_stt-l2_worst.csv
python plot_stuff.py step3/slowdown_int_sc-imec-a15-p0_stt-l2_typical.csv step3/slowdown_int_sc-imec-a15-p0_stt-l2_worst.csv
python plot_stuff.py step3/slowdown_fp_sc-imec-a15-p0_stt-l2_typical.csv step3/slowdown_fp_sc-imec-a15-p0_stt-l2_worst.csv
python plot_stuff.py step3/slowdown_int_sc-i7-6700_stt-l3_typical.csv step3/slowdown_int_sc-i7-6700_stt-l3_worst.csv
python plot_stuff.py step3/slowdown_fp_sc-i7-6700_stt-l3_typical.csv step3/slowdown_fp_sc-i7-6700_stt-l3_worst.csv
python plot_stuff.py step3/baseline_int_sc-a53-odn2_sram-only_typical.csv
python plot_stuff.py step3/baseline_fp_sc-a53-odn2_sram-only_typical.csv
python plot_stuff.py step3/baseline_int_sc-imec-a15-p0_sram-only_typical.csv
python plot_stuff.py step3/baseline_fp_sc-imec-a15-p0_sram-only_typical.csv
python plot_stuff.py step3/baseline_int_sc-i7-6700_sram-only_typical.csv
python plot_stuff.py step3/baseline_fp_sc-i7-6700_sram-only_typical.csv
