...
subset = {
    "test" : {
        "400.perlbench"     : ("makerand", "pack"),
        "401.bzip2"         : ("dryer_2", "input_program_5"),
        "445.gobmk"         : ("capture", "connection", "connect", "cutstone", "dniwog")
    },
    "train" : {
        "400.perlbench"     : ("scrabbl", "suns"),
...
params = {
    "test" : {
        "400.perlbench"     : ("-I. -I./lib makerand.pl", "-I. -I./lib pack.pl"),
        ...
        "444.namd"          : "--input namd.input --iterations 1 --output ../test/namd.out",
    ...
    "train" : {
        "400.perlbench"     : ("-I. -I./lib scrabbl.pl", "-I. -I./lib suns.pl"),
        ...
        "435.gromacs"       : "-silent -deffnm gromacs -nice 0",
        "436.cactusADM"     : "benchADM.par",
        "444.namd"          : "--input namd.input --iterations 1 --output ../train/namd.out",
...
input = {
    "test" : {
        ...
        "445.gobmk"         : ("capture.tst", "connection.tst", "connect.tst", "cutstone.tst", "dniwog.tst")
    },
    "train" : {
        "465.tonto"         : "stdin",
