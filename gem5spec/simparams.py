...
mem_configs = {
    "sc-i7-6700" : {    # L3 response latency guessed, L3 size is the average per-core (2MB x 4 = 8MB total)
        "sram" : {
            ...
            "worst_write"   : ((4, 4, 4, 4, '32kB', 8), (4, 4, 4, 4, '32kB', 8), (8, 8, 8, 8, '256kB', 4), (30, 30, 30, 20, '2MB', 16)),
        ...
        "stt-mram" : {  # TODO: check L2
            ...
            "worst_write"   : ((12, 77, 4, 4, '32kB', 8), (12, 77, 4, 4, '32kB', 8), (23, 80, 8, 8, '256kB', 4), (31, 107, 30, 20, '2MB', 16)),
    ...
    "sc-imec-a7" : {
        "sram" : {
            ...
            "worst_write"   : ((2, 2, 2, 2, '16kB', 2), (2, 2, 2, 2, '16kB', 4), (8, 8, 8, 8, '256kB', 8)),
            "worst"         : ((2, 2, 2, 2, '16kB', 2), (2, 2, 2, 2, '16kB', 4), (8, 8, 8, 8, '256kB', 8))
        },
        "stt-mram" : {
            "typical"       : ((4, 11, 2, 2, '16kB', 2), (4, 11, 2, 2, '16kB', 4), (8,  14, 8, 8, '256kB', 8)),
            "worst_write"   : ((4, 14, 2, 2, '16kB', 2), (4, 14, 2, 2, '16kB', 4), (8,  28, 8, 8, '256kB', 8)),
    ...
    "sc-imec-a15" : {
        "sram" : {
            ...
            "worst_write"   : ((2, 2, 2, 2, '32kB', 2), (2, 2, 2, 2, '32kB', 2), (12, 12, 12, 12, '1MB', 16)),
            "worst"         : ((2, 2, 2, 2, '32kB', 2), (2, 2, 2, 2, '32kB', 2), (12, 12, 12, 12, '1MB', 16))
        },
        "stt-mram" : {
            "typical"       : ((6,  21, 2, 2, '32kB', 2), (6,  21, 2, 2, '32kB', 2), (12, 21, 12, 12, '1MB', 16)),
            "worst_write"   : ((6,  40, 2, 2, '32kB', 2), (6,  40, 2, 2, '32kB', 2), (12, 40, 12, 12, '1MB', 16)),
    ...
    "sc-imec-a15-p2" : {
        "sram" : {
            ...
            "worst_write"   : ((2, 2, 2, 2, '32kB', 2), (2, 2, 2, 2, '32kB', 2), (12, 12, 12, 12, '512kB', 8)),
            "worst"         : ((2, 2, 2, 2, '32kB', 2), (2, 2, 2, 2, '32kB', 2), (12, 12, 12, 12, '512kB', 8))
        },
        "stt-mram" : {
            "typical"       : ((6,  21, 2, 2, '32kB', 2), (6,  21, 2, 2, '32kB', 2), (12, 21, 12, 12, '512kB', 8)),
            "worst_write"   : ((6,  40, 2, 2, '32kB', 2), (6,  40, 2, 2, '32kB', 2), (12, 40, 12, 12, '512kB', 8)),
    ...
    "sc-imec-a15-p4" : {
        "sram" : {
            ...
            "worst_write"   : ((2, 2, 2, 2, '32kB', 2), (2, 2, 2, 2, '32kB', 2), (12, 12, 12, 12, '256kB', 4)),
            "worst"         : ((2, 2, 2, 2, '32kB', 2), (2, 2, 2, 2, '32kB', 2), (12, 12, 12, 12, '256kB', 4))
        },
        "stt-mram" : {
            "typical"       : ((6,  21, 2, 2, '32kB', 2), (6,  21, 2, 2, '32kB', 2), (12, 21, 12, 12, '256kB', 4)),
            "worst_write"   : ((6,  40, 2, 2, '32kB', 2), (6,  40, 2, 2, '32kB', 2), (12, 40, 12, 12, '256kB', 4)),
    ...
    "sc-a53-odn2" : {
        "sram" : {
            ...
            "worst_write"   : ((4, 4, 4, 4, '32kB', 2), (4, 4, 4, 4, '32kB', 4), (9, 9, 9, 9, '512kB', 16)),
        ...
        "stt-mram" : {  # Latencies similar to the same config in A15 (sizes are the same)
            ...
            "worst_write"   : ((5, 30, 4, 4, '32kB', 2), (5, 30, 4, 4, '32kB', 4), (9,  31, 9, 9, '512kB', 16)),
