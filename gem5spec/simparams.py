...
mem_configs = {
    ...
    "sc-imec-a15-p2" : {
        "sram" : {
            ...
            "w-write"   : ((2, 2, 2, 2, '32kB', 2), (2, 2, 2, 2, '32kB', 2), (12, 12, 12, 12, '512kB', 8)),
            "worst"     : ((2, 2, 2, 2, '32kB', 2), (2, 2, 2, 2, '32kB', 2), (12, 12, 12, 12, '512kB', 8))
        },
        "stt-mram" : {
            "typical"   : ((6,  21, 2, 2, '32kB', 2), (6,  21, 2, 2, '32kB', 2), (12, 21, 12, 12, '512kB', 8)),
            "w-write"   : ((6,  40, 2, 2, '32kB', 2), (6,  40, 2, 2, '32kB', 2), (12, 40, 12, 12, '512kB', 8)),
    ...
    "sc-imec-a15-p4" : {
        "sram" : {
            ...
            "w-write"   : ((2, 2, 2, 2, '32kB', 2), (2, 2, 2, 2, '32kB', 2), (12, 12, 12, 12, '256kB', 4)),
            "worst"     : ((2, 2, 2, 2, '32kB', 2), (2, 2, 2, 2, '32kB', 2), (12, 12, 12, 12, '256kB', 4))
        },
        "stt-mram" : {
            "typical"   : ((6,  21, 2, 2, '32kB', 2), (6,  21, 2, 2, '32kB', 2), (12, 21, 12, 12, '256kB', 4)),
            "w-write"   : ((6,  40, 2, 2, '32kB', 2), (6,  40, 2, 2, '32kB', 2), (12, 40, 12, 12, '256kB', 4)),
