...
cpu_models = {
    "aarch64" : {
        ...
        "sc-imec-a15-p0"    : ("CortexA15", "se.py", "1.32V", "2.1GHz"),   # TODO: figure out whether this is still ok
        "sc-imec-a15-p2"    : ("CortexA15", "se.py", "1.32V", "2.1GHz"),
        "sc-imec-a15-p4"    : ("CortexA15", "se.py", "1.32V", "2.1GHz")
    },
    "armhf" : {
        "sc-imec-a7"        : ("CortexA7",  "se.py", "1.27V", "1.4GHz"),
        "sc-imec-a15-p0"    : ("CortexA15", "se.py", "1.32V", "2.1GHz"),
        "sc-imec-a15-p2"    : ("CortexA15", "se.py", "1.32V", "2.1GHz"),
        "sc-imec-a15-p4"    : ("CortexA15", "se.py", "1.32V", "2.1GHz")
    },
    "x86-64" : {
...
mem_configs = {
    "sc-i7-6700" : {    # L3 response latency guessed, L3 size is the average per-core (2MB x 4 = 8MB total)
        "sram" : {
            ...
            "worst-write"   : ((4, 4, 4, 4, '32kB', 8), (4, 4, 4, 4, '32kB', 8), (8, 8, 8, 8, '256kB', 4), (30, 30, 30, 20, '2MB', 16)),
        ...
        "stt-mram" : {  # TODO: check L2
            ...
            "worst-write"   : ((12, 77, 4, 4, '32kB', 8), (12, 77, 4, 4, '32kB', 8), (23, 80, 8, 8, '256kB', 4), (31, 107, 30, 20, '2MB', 16)),
    ...
    "sc-imec-a7" : {
        "sram" : {
            ...
            "worst-write"   : ((2, 2, 2, 2, '16kB', 2), (2, 2, 2, 2, '16kB', 4), (8, 8, 8, 8, '256kB', 8)),
            "worst"         : ((2, 2, 2, 2, '16kB', 2), (2, 2, 2, 2, '16kB', 4), (8, 8, 8, 8, '256kB', 8))
        },
        "stt-mram" : {
            "typical"       : ((4, 11, 2, 2, '16kB', 2), (4, 11, 2, 2, '16kB', 4), (8,  14, 8, 8, '256kB', 8)),
            "worst-write"   : ((4, 14, 2, 2, '16kB', 2), (4, 14, 2, 2, '16kB', 4), (8,  28, 8, 8, '256kB', 8)),
    ...
    "sc-imec-a15-p0" : {
        "sram" : {
            ...
            "worst-write"   : ((2, 2, 2, 2, '32kB', 2), (2, 2, 2, 2, '32kB', 2), (12, 12, 12, 12, '1MB', 16)),
            "worst"         : ((2, 2, 2, 2, '32kB', 2), (2, 2, 2, 2, '32kB', 2), (12, 12, 12, 12, '1MB', 16))
        },
        "stt-mram" : {
            "typical"       : ((6,  21, 2, 2, '32kB', 2), (6,  21, 2, 2, '32kB', 2), (12, 21, 12, 12, '1MB', 16)),
            "worst-write"   : ((6,  40, 2, 2, '32kB', 2), (6,  40, 2, 2, '32kB', 2), (12, 40, 12, 12, '1MB', 16)),
            "worst"         : ((12, 40, 2, 2, '32kB', 2), (12, 40, 2, 2, '32kB', 2), (21, 40, 12, 12, '1MB', 16))
        }
    },
    "sc-imec-a15-p2" : {
        "sram" : {
            "typical"       : ((2, 2, 2, 2, '32kB', 2), (2, 2, 2, 2, '32kB', 2), (12, 12, 12, 12, '512kB', 8)),
            "worst-write"   : ((2, 2, 2, 2, '32kB', 2), (2, 2, 2, 2, '32kB', 2), (12, 12, 12, 12, '512kB', 8)),
            "worst"         : ((2, 2, 2, 2, '32kB', 2), (2, 2, 2, 2, '32kB', 2), (12, 12, 12, 12, '512kB', 8))
        },
        "stt-mram" : {
            "typical"       : ((6,  21, 2, 2, '32kB', 2), (6,  21, 2, 2, '32kB', 2), (12, 21, 12, 12, '512kB', 8)),
            "worst-write"   : ((6,  40, 2, 2, '32kB', 2), (6,  40, 2, 2, '32kB', 2), (12, 40, 12, 12, '512kB', 8)),
            "worst"         : ((12, 40, 2, 2, '32kB', 2), (12, 40, 2, 2, '32kB', 2), (21, 40, 12, 12, '512kB', 8))
        }
    },
    "sc-imec-a15-p4" : {
        "sram" : {
            "typical"       : ((2, 2, 2, 2, '32kB', 2), (2, 2, 2, 2, '32kB', 2), (12, 12, 12, 12, '256kB', 4)),
            "worst-write"   : ((2, 2, 2, 2, '32kB', 2), (2, 2, 2, 2, '32kB', 2), (12, 12, 12, 12, '256kB', 4)),
            "worst"         : ((2, 2, 2, 2, '32kB', 2), (2, 2, 2, 2, '32kB', 2), (12, 12, 12, 12, '256kB', 4))
        },
        "stt-mram" : {
            "typical"       : ((6,  21, 2, 2, '32kB', 2), (6,  21, 2, 2, '32kB', 2), (12, 21, 12, 12, '256kB', 4)),
            "worst-write"   : ((6,  40, 2, 2, '32kB', 2), (6,  40, 2, 2, '32kB', 2), (12, 40, 12, 12, '256kB', 4)),
            "worst"         : ((12, 40, 2, 2, '32kB', 2), (12, 40, 2, 2, '32kB', 2), (21, 40, 12, 12, '256kB', 4))
        }
    },
    "sc-a53-odn2" : {
        "sram" : {
            "typical"       : ((4, 4, 4, 4, '32kB', 2), (4, 4, 4, 4, '32kB', 4), (9, 9, 9, 9, '512kB', 16)),
            "worst-write"   : ((4, 4, 4, 4, '32kB', 2), (4, 4, 4, 4, '32kB', 4), (9, 9, 9, 9, '512kB', 16)),
        ...
        "stt-mram" : {  # Latencies similar to the same config in A15 (sizes are the same)
            ...
            "worst-write"   : ((5, 30, 4, 4, '32kB', 2), (5, 30, 4, 4, '32kB', 4), (9,  31, 9, 9, '512kB', 16)),
