...
(time $GEM5/build/ARM/gem5.fast --outdir=../makerand_test $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/arm/400.perlbench/simpoint/simpoint_makerand_test,$BENCH_DATA/arm/400.perlbench/simpoint/weight_makerand_test,100000000,0 --output=../makerand_test/400perlbench.out --cmd=$SPEC/400.perlbench/exe/perlbench_base.arm --options="-I. -I./lib makerand.pl") &> ../makerand_test/gem5.400perlbench.log &
(time $GEM5/build/ARM/gem5.fast --outdir=../pack_test $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/arm/400.perlbench/simpoint/simpoint_pack_test,$BENCH_DATA/arm/400.perlbench/simpoint/weight_pack_test,100000000,0 --output=../pack_test/400perlbench.out --cmd=$SPEC/400.perlbench/exe/perlbench_base.arm --options="-I. -I./lib pack.pl") &> ../pack_test/gem5.400perlbench.log &
cd ../../..
...
(time $GEM5/build/ARM/gem5.fast --outdir=../dryer_2_test $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/arm/401.bzip2/simpoint/simpoint_dryer_2_test,$BENCH_DATA/arm/401.bzip2/simpoint/weight_dryer_2_test,100000000,0 --output=../dryer_2_test/401bzip.out --cmd=$SPEC/401.bzip2/exe/bzip2_base.arm --options="dryer.jpg 2") &> ../dryer_2_test/gem5.401bzip2.log &
(time $GEM5/build/ARM/gem5.fast --outdir=../input_program_5_test $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/arm/401.bzip2/simpoint/simpoint_input_program_5_test,$BENCH_DATA/arm/401.bzip2/simpoint/weight_input_program_5_test,100000000,0 --output=../input_program_5_test/401bzip.out --cmd=$SPEC/401.bzip2/exe/bzip2_base.arm --options="input.program 5") &> ../input_program_5_test/gem5.401bzip2.log &
cd ../../..
...
(time $GEM5/build/ARM/gem5.fast --outdir=../test $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/arm/403.gcc/simpoint/simpoint_test,$BENCH_DATA/arm/403.gcc/simpoint/weight_test,100000000,0 --output=../test/403gcc.out --cmd=$SPEC/403.gcc/exe/gcc_base.arm --options="cccp.in -o cccp.s") &> ../test/gem5.403gcc.log &
cd ../../..
...
(time $GEM5/build/ARM/gem5.fast --outdir=../test $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/arm/410.bwaves/simpoint/simpoint_test,$BENCH_DATA/arm/410.bwaves/simpoint/weight_test,100000000,0 --output=../test/410bwaves.out --cmd=$SPEC/410.bwaves/exe/bwaves_base.arm --options="bwaves.in") &> ../test/gem5.410bwaves.log &
cd ../../..
...
#(time $GEM5/build/ARM/gem5.fast --outdir=../test $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/arm/416.gamess/simpoint/simpoint_test,$BENCH_DATA/arm/416.gamess/simpoint/weight_test,100000000,0 --output=../test/416gamess.out --mem-size=2GB --cmd=$SPEC/416.gamess/exe/gamess_base.arm --input="exam29.config") &> ../test/gem5.416gamess.log &
#cd ../../..
...
(time $GEM5/build/ARM/gem5.fast --outdir=../test $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/arm/429.mcf/simpoint/simpoint_test,$BENCH_DATA/arm/429.mcf/simpoint/weight_test,100000000,0 --output=../test/429mcf.out --cmd=$SPEC/429.mcf/exe/mcf_base.arm --options="inp.in") &> ../test/gem5.429mcfb.log &
cd ../../..
...
(time $GEM5/build/ARM/gem5.fast --outdir=../test $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/arm/433.milc/simpoint/simpoint_test,$BENCH_DATA/arm/433.milc/simpoint/weight_test,100000000,0 --output=../test/433milc.out --cmd=$SPEC/433.milc/exe/milc_base.arm --input="su3imp.in") &> ../test/gem5.429mcf.log &
cd ../../..
...
(time $GEM5/build/ARM/gem5.fast --outdir=../test $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/arm/434.zeusmp/simpoint/simpoint_test,$BENCH_DATA/arm/434.zeusmp/simpoint/weight_test,100000000,0 --output=../test/434zeusmp.out --mem-size=2GB --cmd=$SPEC/434.zeusmp/exe/zeusmp_base.arm) &> ../test/gem5.434zeusmp.log &
cd ../../..
...
(time $GEM5/build/ARM/gem5.fast --outdir=../test $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/arm/435.gromacs/simpoint/simpoint_test,$BENCH_DATA/arm/435.gromacs/simpoint/weight_test,100000000,0 --output=../test/435gromacs.out --cmd=$SPEC/435.gromacs/exe/gromacs_base.arm --options="-silent -deffnm gromacs -nice 0") &> ../test/gem5.435gromacs.log &
cd ../../..
...
(time $GEM5/build/ARM/gem5.fast --outdir=../test $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/arm/436.cactusADM/simpoint/simpoint_test,$BENCH_DATA/arm/436.cactusADM/simpoint/weight_test,100000000,0 --output=../test/436cactusADM.out --cmd=$SPEC/436.cactusADM/exe/cactusADM_base.arm --options="benchADM.par") &> ../test/gem5.436cactusADM.log &
cd ../../..
...
(time $GEM5/build/ARM/gem5.fast --outdir=../test $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/arm/437.leslie3d/simpoint/simpoint_test,$BENCH_DATA/arm/437.leslie3d/simpoint/weight_test,100000000,0 --output=../test/437leslie3d.out --cmd=$SPEC/437.leslie3d/exe/leslie3d_base.arm --input="leslie3d.in") &> ../test/gem5.437leslie3d.log &
cd ../../..
...
(time $GEM5/build/ARM/gem5.fast --outdir=../test $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/arm/444.namd/simpoint/simpoint_test,$BENCH_DATA/arm/444.namd/simpoint/weight_test,100000000,0 --output=../test/444namd.out --cmd=$SPEC/444.namd/exe/namd_base.arm --options="--input namd.input --iterations 1 --output ../test/namd.out") &> ../test/gem5.444namd.log &
cd ../../..
...
(time $GEM5/build/ARM/gem5.fast --outdir=../capture_test $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/arm/445.gobmk/simpoint/simpoint_capture_test,$BENCH_DATA/arm/445.gobmk/simpoint/weight_capture_test,100000000,0 --output=../capture_test/445gobmk.out --cmd=$SPEC/445.gobmk/exe/gobmk_base.arm --options="--quiet --mode gtp" --input="capture.tst") &> ../capture_test/gem5.445gobmk.log &
(time $GEM5/build/ARM/gem5.fast --outdir=../connection_test $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/arm/445.gobmk/simpoint/simpoint_connection_test,$BENCH_DATA/arm/445.gobmk/simpoint/weight_connection_test,100000000,0 --output=../connection_test/445gobmk.out --cmd=$SPEC/445.gobmk/exe/gobmk_base.arm --options="--quiet --mode gtp" --input="connection.tst") &> ../connection_test/gem5.445gobmk.log &
(time $GEM5/build/ARM/gem5.fast --outdir=../connect_test $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/arm/445.gobmk/simpoint/simpoint_connect_test,$BENCH_DATA/arm/445.gobmk/simpoint/weight_connect_test,100000000,0 --output=../connect_test/445gobmk.out --cmd=$SPEC/445.gobmk/exe/gobmk_base.arm --options="--quiet --mode gtp" --input="connect.tst") &> ../connect_test/gem5.445gobmk.log &
(time $GEM5/build/ARM/gem5.fast --outdir=../cutstone_test $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/arm/445.gobmk/simpoint/simpoint_cutstone_test,$BENCH_DATA/arm/445.gobmk/simpoint/weight_cutstone_test,100000000,0 --output=../cutstone_test/445gobmk.out --cmd=$SPEC/445.gobmk/exe/gobmk_base.arm --options="--quiet --mode gtp" --input="cutstone.tst") &> ../cutstone_test/gem5.445gobmk.log &
(time $GEM5/build/ARM/gem5.fast --outdir=../dniwog_test $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/arm/445.gobmk/simpoint/simpoint_dniwog_test,$BENCH_DATA/arm/445.gobmk/simpoint/weight_dniwog_test,100000000,0 --output=../dniwog_test/445gobmk.out --cmd=$SPEC/445.gobmk/exe/gobmk_base.arm --options="--quiet --mode gtp" --input="dniwog.tst") &> ../dniwog_test/gem5.445gobmk.log &
cd ../../..
...
(time $GEM5/build/ARM/gem5.fast --outdir=../test $GEM5/configs/example/se.py --cpu-type=AtomicSimpleCPU --take-simpoint-checkpoint=$BENCH_DATA/arm/447.dealII/simpoint/simpoint_test,$BENCH_DATA/arm/447.dealII/simpoint/weight_test,100000000,0 --output=../test/447dealII.out --cmd=$SPEC/447.dealII/exe/dealII_base.arm --options="8") &> ../test/gem5.447dealII.log &
cd ../../..
